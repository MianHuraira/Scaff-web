...
import logo2 from './../../images/scaff_cert.svg';
                        ...
                        <div className="main-bar clearfix ">
                            <div className="container clearfix">
                                <div className="logo-header mostion">
                                    <Link to={'./'} className="dez-page scaff"><img src={logo} alt="" /></Link>
                                </div>
                                ...
                                <div className="extra-nav">
                                        <Link to={'./shop-login'} className="dez-page me-3 site-button" style={{margin: "0 10px"}}>Login</Link>
                                        <Link to={'./pricing'} className="dez-page site-button">Register</Link>
                                </div>
