                                    ...
                                    <div className="col-lg-7 col-md-8">
                                        <div className="abuot-box row" >
                                            <div className="col-lg-12 m-b30 text-center ">
                                                <h2 className="box-title m-tb0">Work<span className="text-primary">Smarter</span></h2>
                                            </div>
                                            <div className="col-lg-8">
                                                <ul>
                                                    <li className='m-b20'>Real time updates on each Job</li>
                                                    <li className='m-b20'>Easy onsite Handover/Inspections with Phone or tablet</li>
                                                    <li className='m-b20'>Emailed directly to your Clients from your Device</li>
                                                    <li className='m-b20'>Securely Stores your site photos and job data</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="section-full content-inner" style={{ backgroundImage: "url(" + bgimg2 + ")", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
                            <div className="container">
                                <div className="section-head text-center">
                                    <h2 className="box-title m-tb0 text-primary">Look<span className="text-gray-dark"> at What Our Customers are saying about their Experiences.</span></h2>
                                    <p> A Safer environment starts here. See how you can improve your relationship with major players. </p>
                                </div>
