			...
			<Slider className="owl-slider owl-carousel owl-theme owl-none" {...settings}>
					...
					<div className="slide-content overlay-primary">
						<div className="slide-content-box container">
							<div className="max-w600 text-white">
								<h2 className="text-white font-weight-400">Scaffold<br />Handovers/Inspections <br /></h2>
								<p>Optimize your inspection process,remain 100% compliant with Australian National Laws and regulations.</p>
						...
						<div className="slide-content-box container">
							<div className="max-w600 text-white">
								<h2 className="text-white font-weight-400">
									Digital Records</h2>
								<p>Manage site photo's and Data.Access to Every job Anywhere Anytime.</p>
								<Link to={"#"} className="site-button m-r10 white button-lg">Get Started</Link>
							</div>
						</div>
					</div>
				...
				<div className="item slide-item">
					...
					<div className="slide-content overlay-primary">
						<div className="slide-content-box container">
							<div className="max-w600 text-white">
								<h2 className="text-white font-weight-400">AS/NZS Scaffold<br />Compliance Made Easy <br /></h2>
								<p></p>
								<Link to={"#"} className="site-button m-r10 white button-lg">Get Started</Link>
							</div>
						</div>
